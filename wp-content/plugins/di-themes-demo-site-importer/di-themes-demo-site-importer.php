...
if ( version_compare( phpversion(), '5.3.2', '<' ) ) {
	...
	define( 'DTDSI_VERSION' , '1.1.0' ); // Return version of this plugin.
	...
	function dtdsi_plugin_action_links( $actions ) {
		$custom_link = array(
			'configure' => sprintf( '<a href="%s">%s</a>', admin_url() . 'themes.php?page=dtdsi', __( 'Import Demo', 'dtdsi' ) ),
			);
		return array_merge( $custom_link, $actions );
	}

	/**
	 * [dtdsi_allow_svg_mime_types description]
